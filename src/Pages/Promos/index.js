...
import { View, Text, StyleSheet, Dimensions, ScrollView, ToastAndroid, ActivityIndicator, TextInput, TouchableOpacity, Modal, Picker } from 'react-native';
                ...
                <View style={styles.modalContainer}>
                    <View style={{ height: '50%', backgroundColor: "#FFF", marginTop: '40%', width: '90%', borderRadius: 25 }}>
                        ...
                        <View style={styles.modalBody}>
                            ...
                            <Text style={styles.serviceText}>Descrição: {description}</Text>
                        </View>
                    </View>
                </View>
            </Modal>
